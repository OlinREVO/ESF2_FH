...
\subsection{Accumulator Wiring, Cables, Current Calculations}
    ...
    The low current (IMD, Lights DC-DC, GLV DC-DC and ready to drive sound) TS connections will be made with the wire described in tables \ref{tslowcurrentwire1} - \ref{tslowcurrentwire4}.
    \begin{table}[H]
    \centering
    \begin{tabular}{|l|l|}
    \hline
