...
\begin{tabular}[c]{@{}l@{}}Lights DC-DC converter, \\ TSMPs and IMD\end{tabular} & F3169CT-ND & 7A (for 22 AWG) & 0.5A & \begin{tabular}[c]{@{}l@{}}Protects all TS \\ low current\\ components\end{tabular} \\ \hline
...
\subsection{Accumulator Management System}
    ...
    \textit{Describe the AMS and how it was chosen. Describe generally how it meets the requirements of EV3.7}
        ...
        \begin{table}[H]
            ...
            Upper cell voltage trip & 4.15 \\ \hline
            Lower cell voltage trip & 2.5 \\ \hline
