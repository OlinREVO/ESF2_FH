...
\begin{figure}[H]
 ...
 \caption{Capture of the separation on each AMS board between TS and GLV power on the top copper}
...
\begin{figure}[H]
 ...
 \caption{Capture of the separation on each AMS board between TS and GLV power on the bottom copper}
