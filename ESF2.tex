...
\section*{INTRODUCTION}
    ...
    \textbf{REVIEW PROCESS}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|l|l|}
            \hline
            REVISION DATE & April 10, 2014 \\ \hline
            REVISION (A, B, C, etc...) & A \\ \hline
            \multicolumn{1}{|c|}{Section} & \multicolumn{1}{c|}{Revised (Yes/No)} \\ \hline
            1- Overview & Yes \\ \hline
            2- Cables and Fusing &  Yes \\ \hline
            3- Insulation and Isolation & Yes \\ \hline
            4- Electric Tractive System & Yes \\ \hline
            5- Accumulator System & Yes \\ \hline
            6- GLV System & Yes \\ \hline
            7- Safety Controls and Indicators & Yes \\ \hline
            8- Appendices/Datasheets & Yes \\ \hline
            \end{tabular}
        \end{table}
...
Hosa Tech & Speaker Cable 12 AWG 2 OFC & 12 AWG & PVC & 125 V & 105C & 40A & & & & \\ \hline
\end{tabular}
\end{adjustbox}
...
The fault current for the charging system is restricted by the AC-DC charger for the batteries. The ADC-DC converter can only output 17A, and will restrict any fault current to 17A.
...
The master switches are single pole switches that must be manually closed in order to close the shutdown system. The keys for the master switches are kept in the active Electrical Safety Officer's possession at all times. When disconnected from the vehicle, the keys are also connected to each other, thus disabling closing both switches simultaneously due to the physical separation of the switches and ensuring safety even if the ESO loses possession of the keys. This ensures that a driver can only operate the vehicle under the supervision of the ESO.\\
