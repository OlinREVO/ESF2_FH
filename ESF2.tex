...
CnC Tech & 3132-20-1-0500-001-1-TS & 20 AWG & Silicon Rubber & 300V & 150 C & 7A & MIN2BP & 5A & 25 A2s & 25A & See description \\ \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.6 \textwidth]{CONTROLPANEL_1}
    \caption{Side Panel Front View}
    \label{sidepanelhousing}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width = 0.75 \textwidth]{CONTROLPANEL_2}
    \caption{Side Panel Inside View}
    \label{sidepanelinside}
\end{figure}
