...
\subsection{Accumulator Isolation Relays}
    ...
    The circuitry to support the AIRs- including precharge and discharge circuitry, AMS relays and interlocks can be seen in figure \ref{aircntrlschem}. Its PCB is seen in figure \ref{AIRcntrlPCB}
...
\subsection{Accumulator Wiring, Cables, Current Calculations}
    ...
    The maximum expected current when at 10C is 660A. The nominal current is under NDA.
